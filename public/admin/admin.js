...
(() => {
  ...
  const GAMES = ['archer', 'battleship', 'breakout', 'bricks', 'checkers', 'chess', 'connect4', 'flappy', 'frogger', 'invaders', 'mines', 'missiles', 'parcheesi', 'pong', 'snake', 'tanks', 'tetris', 'tictactoe'];
